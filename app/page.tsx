...
import Section from "./_compontents/Section";
...
export default function Home() {
  return (
    <div>
      {/* {loading ? (
        <motion.div
          className={`absolute left-0 top-0 z-30 m-0 h-full w-full bg-black p-0 text-center text-white opacity-95`}
        >
          <div className="">
            <Transition />
          </div>
      ...
      <Transition>
        ...
        <Section>
          <section>
            ...
            <div className="grid grid-cols-1 gap-2 p-10 xl:grid-cols-3">
              <EducationCard
                resultTitle="CGPA"
        ...
        <section className="z-30 my-auto bg-black p-6 text-white shadow-lg shadow-black dark:bg-white dark:text-black">
          ...
          <p className="text-center text-gray-500">
            I learn those skill From my university and from online Resources
            like Frontend Master, udemy etc.
          </p>
